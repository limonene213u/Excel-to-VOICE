...
@app.route('/sample_voice', methods=['POST'])
def sample_voice():
    sample_word = request.form['sample-word']
    # VOICEVOX APIでサンプルボイスを取得する処理
    # 例: sample_voice = get_sample_voice_from_voicevox(sample_word)
    return f"{sample_word} のサンプルボイスは {sample_voice} にゃ"
